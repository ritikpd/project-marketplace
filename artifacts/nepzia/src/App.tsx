...
const clerkAppearance = {
  ...
  elements: {
    ...
    footerActionLink: "text-[#4361EE] hover:text-[#5B78FF] font-semibold",
    footerActionText: "text-gray-400",
    dividerText: "text-gray-500",
    identityPreviewEditButton: "text-[#4361EE] hover:text-[#5B78FF]",
    formFieldSuccessText: "text-green-400",
    alertText: "text-white",
    logoBox: "mb-6 flex justify-center",
    logoImage: "h-12 w-auto",
    socialButtonsBlockButton: "border-[#1d243a] hover:bg-[#151b2b] transition-colors",
    formButtonPrimary: "bg-[#4361EE] hover:bg-[#5B78FF] text-white shadow-lg shadow-blue-500/20 transition-all",
    formFieldInput: "bg-[#151b2b] border-[#1d243a] text-white focus:border-[#4361EE] focus:ring-[#4361EE]/20",
    footerAction: "mt-6",
    dividerLine: "bg-[#1d243a]",
    alert: "border-[#4361EE]/50 bg-[#4361EE]/10",
