      ...
      <div className="relative bg-[#0a0f1d] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        {done ? (
          <div className="text-center py-6">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Offer Sent!</h3>
            <p className="text-muted-foreground text-sm mb-5">The seller will be notified of your offer.</p>
            <Button onClick={onClose} className="bg-primary hover:bg-primary/90 text-white rounded-xl px-8">Done</Button>
          </div>
        ) : (
          <>
            ...
            <p className="text-sm text-muted-foreground mb-5 truncate">
              ...
              <span className="ml-2 text-muted-foreground/60">Asking Rs. {askingPrice.toLocaleString()}</span>
            </p>

            <div className="mb-4">
              <label className="block text-sm font-medium text-muted-foreground mb-2">Your Offer (Rs.)</label>
              <Input
                type="number"
                value={amount}
              ...
              {amount && (
                <div className="flex justify-between mt-2 text-xs">
                  ...
                  <span className="text-muted-foreground">
                    {pct < 70 ? "Low offer" : pct < 85 ? "Fair offer" : "Strong offer"}
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                placeholder="Hi, I'm interested! Can we meet in Kathmandu?"
                rows={2}
