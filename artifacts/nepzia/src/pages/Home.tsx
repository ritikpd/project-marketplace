...
const CATEGORIES = [
  { name: "Phones", icon: MonitorSmartphone, slug: "phones" },
  { name: "Laptops", icon: Laptop, slug: "laptops" },
  { name: "Gaming", icon: Gamepad2, slug: "gaming-consoles" },
  { name: "Audio", icon: Headphones, slug: "audio-devices" },
  { name: "Cameras", icon: Camera, slug: "cameras" },
  { name: "Watches", icon: Watch, slug: "smart-watches" },
];
    ...
    <div className="flex-col">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <Badge className="mb-6 bg-white/5 text-primary border-white/10 hover:bg-white/10 px-4 py-1.5 backdrop-blur-sm">
            Nepal's Premium Tech Marketplace
          </Badge>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto font-medium">
            Buy and sell verified electronics, smartphones, and laptops with confidence.
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative group">
            ...
            <div className="relative flex items-center bg-[#080d1a] border border-white/10 rounded-full p-2 shadow-2xl backdrop-blur-md">
              ...
              <Input 
                ...
                placeholder="Search for iPhone 15, MacBook Pro, PS5..." 
          ...
          <div className="mt-5 flex items-center justify-center gap-3">
            {geo.city ? (
              <span className="flex items-center gap-1.5 text-sm text-muted-foreground">
                ...
                Showing listings near <span className="text-white font-medium">{geo.city}</span>
              </span>
            ) : (
              <button
                onClick={geo.request}
              ...
              >
                ...
                {geo.loading ? "Detecting location..." : geo.permissionDenied ? "Location denied" : "Detect my location"}
              </button>
            )}
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">Listings in and around <span className="text-white">{geo.city}</span></p>
              </div>
      ...
      {featured && featured.length > 0 && (
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              <h2 className="text-3xl font-bold text-white tracking-tight">Premium Picks</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Active Tech</div>
            </div>
            <div>
              <div className="text-4xl font-black text-white mb-2">{stats?.totalUsers || "5,000+"}</div>
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Enthusiasts</div>
            </div>
            <div>
              <div className="text-4xl font-black text-white mb-2">100%</div>
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Verified</div>
            </div>
            <div>
